...
- "short" — a story worth a mention. The anchor reads it and that is all, or one picture behind them. About 15 seconds.
- "medium" — a normal story. The anchor introduces it, one or two pictures carry it. About 30 seconds.
- "long" — the story the block is actually about. An aerial, several pictures, a correspondent on location, and the anchor closing it out. About 80 seconds.
...
"read" — what the anchor says to camera to introduce the story. One sentence, 14-18 words, broadcast register. Tight: it has to land inside a nine-second clip. State what happened. Do not greet the audience, do not say "welcome back", do not editorialise.

"cuts" — the pictures that follow the read, in order. Each cut is an object with "shot", "voiceover" and "framing".
Number of cuts by treatment: "short" → 0 or 1. "medium" → 1 or 2. "long" → 3 or 4.
  ...
  "voiceover" — what the anchor says over that picture. 15-20 words. It must fit an eleven-second clip.
...
Every "long" story gets one. Otherwise give one only to a story with a real physical place worth standing in, and never more than the number you are told. When you do:
  ...
  "standup" — their piece to camera. 16-20 words, first person, present tense, said on location. Add something neither the read nor any voiceover said. End by handing back to the studio.

"tag" — for "long" stories ONLY, the anchor's closing line back at the desk. 12-16 words. It lands the story; it does not summarise what was just said. Empty string for every other treatment.
